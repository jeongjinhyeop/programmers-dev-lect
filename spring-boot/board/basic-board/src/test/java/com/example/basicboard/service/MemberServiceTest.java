...
class MemberServiceTest {
    ...
    void login_아이디와_비밀번호가_맞으면_회원을_반환한다() {
        ...
        assertThat(result.get().getUserId()).isEqualTo("홍길동");
    }

    @Test
    @DisplayName("로그인 - 아이디가 없으면 빈 Opional을 반환한다.")
    void login_비밀번호가_틀리면_빈_Optioal() {
    ...
    void join_중복이_아니면_저장한다() {
        ...
        given(memberRepository.existsByUserId("nobody")).willReturn(false);
